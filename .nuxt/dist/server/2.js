...
/* harmony default export */ var homevue_type_script_lang_js_ = ({
  ...
  async asyncData({
    ...
    const loadArticles = store.state.user && tag === 'your_feed' ? api_article["f" /* getFeedArticles */] : api_article["d" /* getArticles */];
